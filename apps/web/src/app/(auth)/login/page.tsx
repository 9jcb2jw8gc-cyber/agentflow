      ...
      <div className="w-full max-w-sm space-y-8 p-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Sign in to start building agent configurations
          </p>
        </div>
